...
def auto_register(registry: MacRegistry) -> None:
    ...
    sub_packages = sorted(["", "connectors", "exporters", "transformers", "readers", "parsers", "validators", "mappers", "casters", "schemas", "rules", "staging", "importers", "reconciliation", "loaders", "execution"])
