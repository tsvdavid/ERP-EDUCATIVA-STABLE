...
const DebitNoteForm = () => {
    ...
    useEffect(() => {
        const fetchInvoices = async () => {
            try {
                ...
                // Solo cargar facturas validadas para aplicar notas de debito
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            await purchaseService.createDebitNote(payload);
            navigate('/dashboard/purchases/debit-notes');
        } catch (error) {
            console.error("Error al registrar", error);
            alert("Error al guardar la Nota de Débito. Verifique que el Secuencial no esté repetido o falten campos.");
        }
    };
    ...
    return (
        <div className="p-6 max-w-4xl mx-auto">
            <div className="flex justify-between items-center mb-6">
                <h1 className="text-2xl font-bold text-gray-800">Nueva Nota de Débito</h1>
                <button
                    onClick={() => navigate('/dashboard/purchases/debit-notes')}
            ...
            <div className="bg-white rounded-xl shadow-sm border border-slate-200 overflow-hidden">
                <form onSubmit={handleSubmit} className="p-6 space-y-6">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            <label className="block text-sm font-medium text-slate-700 mb-1">Motivo del Incremento *</label>
                            <input
                                type="text"
                                name="reason"
                                placeholder="Ej: Recargo por Transporte"
                        ...
                        <div className="md:col-span-2 mt-4 pt-4 border-t border-slate-100 grid grid-cols-1 sm:grid-cols-2 gap-6">
                            ...
                            <div>
                                <label className="block text-sm font-medium text-slate-700 mb-1">Tarifa IVA del recargo *</label>
                                <select
                                    name="tax_rate"
